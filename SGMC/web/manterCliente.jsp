            ...
            <table>
                <tr>
                    <td><label>ID Cliente: </label>
                        ...
                        <td><input type="radio" name="tipoPessoa" value="${cliente.tipoPessoa}" >Pessoa Juridica<br>
                            <input type="radio" name="tipoPessoa" value="${cliente.tipoPessoa}">Pessoa Fisica</td>
                ...
                <tr>
                        ...
                        <td><label>RG: </label>
                            <input type="text" name="numRg" value="${cliente.rg}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>></td>
                        <td><label>CNPJ: </label>
