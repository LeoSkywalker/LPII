...
--
-- Host: localhost
-- Generation Time: 30-Set-2019 às 18:30
...
INSERT INTO `colaborador` (`idColaborador`, `cpf`, `rg`, `dataNascimento`, `telefone`, `celular`, `estadoCivil`, `sexo`, `idUsuario`, `idEndereco`) VALUES
(1, '11122233305', '223335556', '2000-04-30', '21324434', '2299988877', 'Solteiro', '0', 1, 2),
(2, '121324234234', '233334324', '1997-09-10', '21232132344', '312343242332', 'Casado', '0', 2, 1);
...
(2, 'Rua B', 104, 'Ao lado da Loja C', 'Juiz de Fora', 'Manoel Honório', 'MG', '36045051');
...
(1, NULL, '15842', '444', 'Caixa Economica', 'Conta Corrente', 10, 30, 5.8, 6, 4.5, 'Automatico'),
(2, NULL, '215753', '555', 'Banco Itau', 'Conta Corrente', 12, 30, 4.8, 6.2, 4.8, 'Automatico'),
(3, NULL, '123234', '777', 'Banco Bradesco', 'Conta Poupanca', 1, 1, NULL, NULL, NULL, 'Automatica');
...
(2, 'Rafael Franco', 'rafaelfranco.rf@gmail.com', '12345');
...
ALTER TABLE `colaborador`
  ...
  ADD KEY `fk_colaborador_usuario1_idx` (`idUsuario`),
...
ALTER TABLE `colaborador`
  ...
  ADD CONSTRAINT `fk_colaborador_usuario1` FOREIGN KEY (`idUsuario`) REFERENCES `usuario` (`idUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;
